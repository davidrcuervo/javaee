...
public class FormRepositoryDeprecated {
	private final static Logger log = LogManager.getLogger(FormRepositoryDeprecated.class);
	
	private Form form;
	private InputVerification check;

	public FormRepositoryDeprecated(String name, String clase, String email, String thankyou, JsonDb jdb) {
	...
	public FormRepositoryDeprecated(String name, String clase, JsonDb jdb) {
		check = new InputVerification();
		form = new Form();
		setName(name, jdb);
		setClase(clase);
