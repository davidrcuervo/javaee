...
public class FilterPath implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        log.debug("request.getServerName(): {}", httpReq.getServerName());
		log.debug("request.getContextPath(): {}", httpReq.getContextPath());
        log.debug("request.getServletPath(): {}", httpReq.getServletPath());
        log.debug("request.getPathInfo(): {}", httpReq.getPathInfo());
        log.debug("request.getQueryString(): {}", httpReq.getQueryString());
