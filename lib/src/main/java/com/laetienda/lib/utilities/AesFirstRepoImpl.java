 ...
 * 
 */
public class AesFirstRepoImpl implements Aes {
	
	private final static Logger log = LogManager.getLogger(AesFirstRepoImpl.class);
...
//		String password = "www.myself.com";
		final String username = "cn=admin,dc=example,dc=com";
		String password = "www.myself.com";
		
		
		//Example of hashing a password
	    Aes en=new AesFirstRepoImpl();
	    ...
	    Aes de =new AesFirstRepoImpl();
	    try {
	    	password = de.decrypt(encryptedWord, username);
